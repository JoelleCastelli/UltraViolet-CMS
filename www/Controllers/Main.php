...
class Main
{
    ...
    private function populateArticles()
    {
        ...
        $description = "Mauris vitae sapien at mauris finibus suscipit nec a nulla. Cras iaculis venenatis cursus. Sed volutpat velit vitae enim egestas, sit amet maximus nisi bibendum. Ut vel turpis id enim aliquam placerat. Phasellus auctor fringilla libero a pulvinar.";
